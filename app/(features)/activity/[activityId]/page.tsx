...
import getActivitiesId from "@api/Activities/getActivitiesId"; //체험 정보를 가져오는 API 함수
  ...
  return (
    <div className="container mx-auto px-4">
      <div className="flex items-center justify-between py-4">
        ...
        <div className="flex-none">{isOwner && <DropDownMenu activityId={Number(params.activityId)} />}</div>
      </div>
