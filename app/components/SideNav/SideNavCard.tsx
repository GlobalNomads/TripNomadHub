...
function SideNavCard(): React.JSX.Element {
  return (
    <div className="hidden h-[432px] w-[251px] rounded-2xl border border-solid border-gray-300 bg-white drop-shadow-sm md:flex md:flex-col xl:h-[432px] xl:w-[384px]">
