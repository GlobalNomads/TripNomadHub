"use client";
import AccountCheck from "@/app/assets/icon/ic_account_check_outline.svg";
import Calender from "@/app/assets/icon/ic_calendar_check_outline.svg";
import Cog from "@/app/assets/icon/ic_cog_outline.svg";
import GrayAccountCheck from "@/app/assets/icon/ic_gray_account_check_outline.svg";
import GrayCalender from "@/app/assets/icon/ic_gray_calender.svg";
import GrayCog from "@/app/assets/icon/ic_gray_cog.svg";
import GrayTextBoxCheck from "@/app/assets/icon/ic_gray_text_box_check_outline.svg";
import Pencil from "@/app/assets/icon/ic_pencil.svg";
import TextBoxCheck from "@/app/assets/icon/ic_text_box_check_outline.svg";
