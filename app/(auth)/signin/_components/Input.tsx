...
export default forwardRef(function Input(
  ...
  return (
    <input
      autoComplete="off"
      className={`box-border w-full rounded-md border border-primary-gray-700 px-4 py-3 text-sm leading-[1.7] text-primary-gray-600 outline-0 placeholder:text-[#8F95B2] ${
        validationCheck
