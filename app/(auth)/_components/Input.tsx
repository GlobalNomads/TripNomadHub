...
export default forwardRef(function Input(
  { validationCheck, type, ...rest }: IInputProps,
  ...
  return (
    <div className="relative">
      <input
        type={inputType}
        autoComplete="off"
        className={`box-border w-full rounded-md border border-primary-gray-400 px-4 py-3 text-sm-medium text-primary-gray-600 outline-0 placeholder:text-[#8F95B2] ${
          validationCheck
